...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
 ...
 [_NAV] = LAYOUT(MACRO_QUIT, LCTL(KC_W), KC_TRANSPARENT, LCTL(KC_R), LCTL(KC_T),                 LCTL(LALT(KC_L)), KC_HOME, KC_PGDN, KC_PGUP, KC_END,
		 KC_ESC, MACRO_SAVE, MACRO_LINE, MACRO_TIME, TG(_NAV),                      KC_TRANSPARENT, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT,
 ...
 [_MOUSE] = LAYOUT(KC_TRANSPARENT, LCTL(KC_W), KC_MS_UP, LCTL(KC_R), LCTL(KC_T),                         KC_MEDIA_NEXT_TRACK, KC_UP, KC_MS_WH_UP, KC_PGUP,NO_ARNG,
		   KC_ESC, KC_MS_LEFT, KC_MS_DOWN,  KC_MS_RIGHT, TG(_MOUSE),                  KC_MEDIA_PLAY_PAUSE, KC_MS_BTN1, KC_MS_BTN3, KC_MS_BTN2, NO_AE,
		   KC_MS_BTN2, KC_MS_WH_LEFT, KC_TRANSPARENT, KC_MS_WH_RIGHT, TG(_NAV),          KC_MEDIA_PREV_TRACK, KC_DOWN, KC_MS_WH_DOWN, KC_PGDN, KC_TRANSPARENT,
